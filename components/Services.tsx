...
export const Services: React.FC = () => {
  return (
    <section id="services" className="py-24 bg-transparent border-b border-white/5">
      <div className="max-w-7xl mx-auto px-6">
        <div className="mb-16 text-center max-w-3xl mx-auto">
          <h2 className="text-3xl md:text-4xl font-bold mb-4 tracking-tight text-transparent bg-clip-text bg-gradient-to-b from-white to-zinc-400">
            Our Services
          </h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
          {services.map((service, index) => (
            <SpotlightCard key={index} className="h-full bg-zinc-900/40 border-zinc-800 backdrop-blur-sm" spotlightColor="rgba(74, 222, 128, 0.1)">
