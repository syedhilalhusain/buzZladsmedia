...
export const Blog: React.FC = () => {
  return (
    <section id="blog" className="py-24 bg-transparent border-b border-white/5">
      <div className="max-w-7xl mx-auto px-6">
        <div className="flex flex-col md:flex-row justify-between items-end mb-12">
          <div>
            <h2 className="text-3xl md:text-4xl font-bold mb-2 tracking-tight text-transparent bg-clip-text bg-gradient-to-b from-white to-zinc-400">Latest from the Blog</h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {posts.map((post, i) => (
            <SpotlightCard key={i} className="group cursor-pointer bg-zinc-900/40 border-zinc-800 backdrop-blur-sm" spotlightColor="rgba(255, 255, 255, 0.1)">
